<template>
    <div>
    <div class="py-8 lg:py-16 px-4 mx-10 md:mx-auto max-w-screen-md bg-white rounded-xl">
        <h2 class="mb-10 text-5xl tracking-tight font-extrabold text-left text-gray-900 dark:text-white">Ask anything</h2>
    <form action="#" class="space-y-8">
            <div class="flex justify-items-start justify-between space-x-3">
                <div class="flex-2 w-1/3 ">
                    <label for="firstname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
                ...
                <div class="flex-2 w-1/3">
                    <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
                    <input type="text" id="lastname" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Last name" required>
                </div>
                <div class="flex-3 w-1/3">
